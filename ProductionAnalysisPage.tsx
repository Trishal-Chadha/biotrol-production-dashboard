...
const CHART_COLORS = ['#2563eb', '#059669', '#f59e0b', '#dc2626', '#7c3aed', '#06b6d4', '#ec4899', '#84cc16'];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          ...
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData.daily}>
                ...
                <Area type="monotone" dataKey="produced" stroke="#2563eb" fill="url(#gDailyProd)" name="Sheets" strokeWidth={2} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </ChartCard>
        ...
        <ChartCard title="Employee Efficiency">
          <div className="h-56">
            {chartData.employeeEff.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <ReBar data={chartData.employeeEff} layout="vertical">
                  <CartesianGrid strokeDasharray="3 3" stroke="#f3f4f6" />
        ...
        <ChartCard title="Target vs Actual Production">
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <ReBar data={chartData.targetVsActual}>
                <CartesianGrid strokeDasharray="3 3" stroke="#f3f4f6" />
                <XAxis dataKey="date" tick={{ fontSize: 10 }} stroke="#9ca3af" />
                <YAxis tick={{ fontSize: 10 }} stroke="#9ca3af" />
                <Tooltip contentStyle={tooltipStyle} />
        ...
        <ChartCard title="Production vs Packaging Comparison">
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <ReBar data={chartData.prodVsPkg}>
                <CartesianGrid strokeDasharray="3 3" stroke="#f3f4f6" />
                <XAxis dataKey="date" tick={{ fontSize: 10 }} stroke="#9ca3af" />
                <YAxis tick={{ fontSize: 10 }} stroke="#9ca3af" />
                <Tooltip contentStyle={tooltipStyle} />
